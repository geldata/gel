...
class SourcePoint:
    ...
    @staticmethod
    def from_offsets(data: bytes, offsets: list[int]) -> list[SourcePoint]: ...
    @staticmethod
    def from_lines_cols(
