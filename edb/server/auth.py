...
if TYPE_CHECKING:
    ...
    class JWKSet:
        ...
        def __init__(self) -> None: ...
        def generate(self, *, kid: str | None, kty: str) -> None: ...
        ...
        def sign(
            self, claims: dict[str, Any], *, ctx: SigningCtx | None = None
        ) -> str: ...
        def validate(
            self, token: str, *, ctx: ValidationCtx | None = None
        ) -> dict[str, Any]: ...
        @property
    ...
    class JWKSetCache:
        ...
        def get(self, key: str) -> tuple[bool, JWKSet | None]: ...
        def set(self, key: str, registry: JWKSet) -> None: ...

    def generate_gel_token(
        registry: JWKSet,
        *,
        instances: list[str] | Iterable[str] | None = None,
        roles: list[str] | Iterable[str] | None = None,
        databases: list[str] | Iterable[str] | None = None,
        **kwargs: Any,
    ) -> str: ...
