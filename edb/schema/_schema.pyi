...
class Schema:
    ...
    def get_data_raw(self, obj: so.Object) -> tuple[typing.Any, ...]: ...
    def get_field_raw(
    ...
    def unset_field(self, obj: so.Object, fieldname: str) -> Schema: ...
    def set_fields(
        self,
        obj: so.Object,
...
class RustSchemaError(Exception):
    def as_duplicate_id(self) -> so.Object | None: ...
    def as_duplicate_name(self) -> so.Object | None: ...
    def as_missing_module(self) -> str | None: ...
    def as_missing_object(self) -> bool: ...
